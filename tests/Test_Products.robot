...
${login}                qa@qa.com.br
${senha}                teste
&{USER_ADM}             nome=Guilherme    email=qa_25_adm@qa.com.br    password=teste1    administrador=true
&{USER_ADM_FALSE}       nome=Guilhermezin    email=qa@qa.com.br    password=teste2    administrador=false
